...
function decodeEveMessage() {
  ...
  socket.emit("eve_decode", { message, encryption: getEncryptionModel(), eavesdropping: isEavesdroppingEnabled() });
}
...
window.sendAliceKey = sendAliceKey;
window.reconcileKey = reconcileKey;
window.sendAliceMessage = sendAliceMessage;
window.decodeBobMessage = decodeBobMessage;
window.decodeEveMessage = decodeEveMessage;
